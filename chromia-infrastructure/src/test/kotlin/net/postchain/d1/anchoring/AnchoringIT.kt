...
class AnchoringIT : ManagedModeTest() {
    ...
    fun happyAnchor(configFile: String) {
        ...
        val anchorHash = gtv(dappBlockRids).merkleHash(GtvMerkleHashCalculatorV1(cryptoSystem))
        ...
        withReadConnection(getChainNodes(anchorChain)[0].postchainContext.blockBuilderStorage, anchorChain) {
            ...
            headers.forEachIndexed { index, header ->
                ...
                val digest = decodedHeader.toGtv().merkleHash(GtvMerkleHashCalculatorV1(cryptoSystem))
