...
exec java -Duser.language=en -Duser.country=US -XX:+UnlockDiagnosticVMOptions -XX:AbortVMOnException=java.lang.OutOfMemoryError -XX:MaxRAMPercentage=$JAVA_MEMORY_SHARE -classpath "@$POSTCHAIN_DIR/jib-classpath-file" net.postchain.server.AppKt run-subnode