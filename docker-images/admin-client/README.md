...
or
docker run -it --rm -e POSTCHAIN_TARGET=localhost:50051 registry.gitlab.com/chromaway/postchain-chromia/chromaway/postchain-admin-client:3.8.0-SNAPSHOT list-peers
```
...
docker run -it --rm \
    ...
    registry.gitlab.com/chromaway/postchain-chromia/chromaway/postchain-admin-client:3.8.0-SNAPSHOT \
