...
In this section various questions that can rise are given some answers.
...
===============================================
You need two key pairs: a node key pair, and a provider key pair. Key pairs can be generated by ./pmc.sh or ./postchain.sh.

Provider Key pair
    You send the public provider key to the admin and you use this key pair whenever you need to prove who you are (that is, a provider with authorities to do stuff). You do that via the parameter -cfg with your prov.cfg file. 
