...
class ChromaWayPostgresContainer(dockerImageName: DockerImageName = DockerImageName.parse("postgres:14.7")) : JdbcDatabaseContainer<ChromaWayPostgresContainer>(dockerImageName) {
