...
class FTAuthenticator(private val client: PostchainClient) {
    ...
    fun findAccountId(pubKey: PubKey): ByteArray {
    ...
    fun findAuthDescriptor(accountId: ByteArray, pubKey: PubKey): AuthDescriptor {
    ...
    fun verifyOperationAuthFlags(authDescriptor: AuthDescriptor, opName: String) {
