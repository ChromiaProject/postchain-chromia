...
object ApiCompatV18 {
    ...
    data class NmGetBlockchainConfigurationV18Result(
            @param:Name("base_config") val baseConfig: WrappedByteArray,
            @param:Name("signers") val signers: List<WrappedByteArray>,
            @param:Name("config_hash") val configHash: WrappedByteArray
    )
